  ...
  public function search(Request $request)
{
    ...
    $filters = $request->all();
        ...
        return view('AutoCare.tyres.search', array_merge($viewData, compact('tyres', 'brands', 'tyreTypes', 'sortBy', 'order', 'seasonTypes', 'vehicleTypes', 'suppliers', 'filters', 'totalQty', 'totalCost')));
}
