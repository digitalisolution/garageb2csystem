...
class MotorbikeTyresProductController extends Controller
{
    ...
    public function motorbikeTyreslist(Request $request, 
    $width = null, 
    $profile = null, 
    $diameter = null, 
    $fitting_type = null, 
...
{
    // Merge route parameters into request if present
    ...
    $query->where('vehicle_type', '=', 'motorbike');
