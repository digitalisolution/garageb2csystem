    ...
    public function showVehicleSearch(Request $request)
{
    ...
    private function saveVehicleDetails(string $vrm, array $data): void
    {
        ...
        $vehicleData = [
            ...
            'vehicle_make' => $data['RapidVehicleDetails']['Make'] ?? null,
            'vehicle_model' => $data['RapidVehicleDetails']['Model'] ?? null,
            'vehicle_year' => Carbon::parse($data['RapidVehicleDetails']['DateOfFirstRegistration'])->format('Y') ?? null,
            'vehicle_first_registered' => Carbon::parse($data['RapidVehicleDetails']['DateOfFirstRegistration'])->format('Y-m-d H:i:s') ?? null,
            ...
            'vehicle_engine_number' => $data['RapidVehicleDetails']['VehicleIdentification']['EngineNumber'] ?? null,
            'vehicle_engine_size' => $data['RapidVehicleDetails']['DvlaTechnicalDetails']['EngineCapacityCc'] ?? null,
            'vehicle_axle' => $data['ModelDetails']['Powertrain']['Transmission']['DriveType'] ?? null,
            'vehicle_vin' => $data['RapidVehicleDetails']['VehicleIdentification']['VinLast5'] ?? null,
            ...
            'vehicle_chassis_no' => $data['RapidVehicleDetails']['VehicleIdentification']['Vin'] ?? null,
