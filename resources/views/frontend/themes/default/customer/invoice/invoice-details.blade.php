                            ...
                            @endif
                                        @if(!empty($tyre) && in_array($tyre->fitting_type, ['fully_fitted']))
                                                <tr>
                                                    ...
                                                    <td align="center"><strong>£{{ number_format($quantity > 0 ? $garageFittingCharges / $quantity : 0, 2) }}</strong>
                                                    </td>
                                                    ...
                                                    <td colspan="" align="right">
                                                        <strong>£{{ number_format($garageFittingCharges + ($garageFittingCharges * $garageVatClass), 2) }}</strong></td>
                                                </tr>
                                            @endif
