@foreach ($recommendedTyres as $tyre)
    ...
    <div class="product-wrap recommended_tyres border-orange mb-15">
        <div class="product-img">
            <div class="tyre_card align-items-center">
                ...
                <div class="tyre-picture">
                    <img src="{{ $imageUrl }}" alt="{{ $tyre->tyre_model }}" width="150" onerror="this.onerror=null;this.src='{{ asset('frontend/themes/default/img/product/sample-tyre.png') }}';">
                </div>
                ...
                <div class="rec_desc">
                    ...
                    <p class="mb-0 tyre_description">
                        ...
                        @if($tyre->tyre_extraload) <b>Reinforced (XL)</b> @endif
                    </p>
                </div>
                <div>
