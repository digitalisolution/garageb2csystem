                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item">
                              <h2 class="accordion-header">
                                <a class="accordion-button" data-bs-toggle="collapse" data-bs-target="#tyre-size" aria-expanded="true" aria-controls="tyre-size">
                                  <h4><img src="frontend/themes/default/img/filter-icons/tyresize_icon.webp" height="18" alt="Tyre Sizes"> Tyre Sizes</h4>
                                </a>
                              </h2>
                                <div id="tyre-size" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <form id="filterForm">
                                        <div class="filter_element">
                                                <!-- Width -->
                                            <div class="item">
                                                <div class="product-filter"><h5>Width</h5></div>
                                            ...
                                            <div class="item">
                                                ...
                                                <input type="hidden" id="ordertype" name="ordertype" value="{{ request('ordertype', '') }}">
                                            </div>
                                            <input type="hidden" id="vehicle_type" name="vehicle_type" value="{{ request('vehicle_type', '') }}">
                                            <input type="hidden" id="ordertype_hidden" name="ordertype" value="{{ request('ordertype', '') }}"> 
                                        </div>
                                        </form>
                                    </div>  
                                </div>
                            ...
                            <div class="accordion-item">
                              <h2 class="accordion-header">
                                <a class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#tyres-brand" aria-expanded="false" aria-controls="tyres-brand">
                                  <h4><img src="frontend/themes/default/img/filter-icons/tyrebrands_icon.webp" height="18" alt="Tyres Brand"> Tyres Brand</h4>
                                </a>
                              </h2>
                              <div id="tyres-brand" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                            ...
                            <div class="accordion-item">
                              <h2 class="accordion-header">
                                <a class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#season" aria-expanded="false" aria-controls="season">
                                  <h4><img src="frontend/themes/default/img/filter-icons/season_icon.webp" height="18" alt="Season"> Season</h4>
                                </a>
                              </h2>
                            ...
                            <div class="accordion-item">
                              <h2 class="accordion-header">
                                <a class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#application" aria-expanded="false" aria-controls="application">
                                  <h4><img src="frontend/themes/default/img/filter-icons/application_icon.webp" height="18" alt="Application"> Application</h4>
                                </a>
                              </h2>
                              <div id="application" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                  <div class="product-filter">
                                        <ul class="color-filter">
                                            <li>
                                                <label>
                                                    <input type="checkbox" name="runflat" value="1" id="runflatCheckbox">
                                                    <a class="filter-label">Run Flat (RFT)</a>
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name="extraload" value="1" id="extraloadCheckbox">
                            ...
                            <div class="accordion-item">
                              <h2 class="accordion-header">
                                <a class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#fuel-efficiency" aria-expanded="false" aria-controls="fuel-efficiency">
                                  <h4><img src="frontend/themes/default/img/filter-icons/fuel_icon.webp" height="18" alt="Fuel Efficiency"> Fuel Efficiency</h4>
                                </a>
                              </h2>
                              <div id="fuel-efficiency" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                  <div class="product-filter">
                            ...
                            <div class="accordion-item">
                              <h2 class="accordion-header">
                                <a class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#wet-grip" aria-expanded="false" aria-controls="wet-grip">
                                  <h4><img src="frontend/themes/default/img/filter-icons/wetgrip_icon.webp" height="18" alt="Wet Grip"> Wet Grip</h4>
                                </a>
                              </h2>
                            ...
                            <div class="accordion-item">
                              <h2 class="accordion-header">
                                <a class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#noise-level" aria-expanded="false" aria-controls="noise-level">
                                  <h4><img src="frontend/themes/default/img/filter-icons/noise_icon.webp" height="18" alt="Noise Level (dB)"> Noise Level (dB)</h4>
                                </a>
                              </h2>
                              <div id="noise-level" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                  <div class="product-filter">
...
@section('scripts')
    ...
    <script>
        ...
        let selectedOrderType = $('#ordertype_hidden').val();
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (selectedOrderType) {
                        $('#orderTypeSelect').val(selectedOrderType);
                    }
                    attachOrderTypeListener();
                },
                error: function (xhr, status, error) {
                    console.error("Error fetching Order Type options:", error);
                    const $orderTypeSelect = $('#orderTypeSelect');
                    $orderTypeSelect.empty();
                    $orderTypeSelect.append(new Option('Any Order Type', ''));
                    attachOrderTypeListener();
        ...
        function attachOrderTypeListener() {
            $('#orderTypeSelect').off('change.orderTypeFilter').on('change.orderTypeFilter', function () {
                ...
                $('#ordertype_hidden').val(selectedOrderType);
        ...
        $(function () {
            ...
            if (orderTypeFromUrl !== null) {
                ...
                $('#ordertype_hidden').val(orderTypeFromUrl);
            }
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (newResponse) {
                                                    if (newResponse.success) {
                                                        // Item added successfully after clearing
                                                        Swal.fire({
                                                            title: 'Product added to cart!',
                                                            text: 'Do you want to add more items or Continue?',
                                                            icon: 'success',
