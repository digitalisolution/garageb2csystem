            ...
            <div class="bg-white p-3">
                ...
                <form action="{{ route('AutoCare.meta-settings.update', $metasettings->setting_id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="name" value="{{ $metasettings->name }}"
                            required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label>
                            <input type="radio" name="status" value="1" {{ $metasettings->status == 1 ? 'checked' : '' }}
                                required>
                            Active
                        </label>
                        <label>
                            <input type="radio" name="status" value="0" {{ $metasettings->status == 0 ? 'checked' : '' }}
                                required>
                            Inactive
                        </label>
                    </div>
