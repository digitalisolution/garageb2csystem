...
@section('content')
    <div class="container-fluid">
        <div class="bg-white p-3">
            <form id="shipping-form" action="{{ route('save.mailshipping.charges') }}" method="POST">
                @csrf
                ...
                <ul class="nav nav-tabs" id="shippingTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="miles-tab" data-bs-toggle="tab" data-bs-target="#miles-pane"
                            type="button" role="tab" aria-controls="miles-pane" aria-selected="true">
                            <h6 class="m-0"><strong>Charges by
                                    Miles</strong></h6>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="postcode-tab" data-bs-toggle="tab" data-bs-target="#postcode-pane"
                            type="button" role="tab" aria-controls="postcode-pane" aria-selected="false">
                            <h6 class="m-0"><strong>Charges by
                                    Postcode</strong></h6>
                        </button>
                    </li>
                                                ...
                                                @foreach ($milesData as $index => $mile)
                                                                    <div class="mile-row shipping_charges_wrap">
                                                                        ...
                                                                        <div class="item">
                                                                            <label>&nbsp;</label>
                                                                            <button type="button"
                                                                                class="btn btn-danger btn-sm remove-mile btn-block">Remove</button>
                                                                        </div>
                                                                    </div>
                                                @endforeach
                            @endif
                                                ...
                                                @foreach ($postcodeData as $index => $postcode)
                                                                    <div class="postcode-row shipping_charges_wrap">
                                                                        ...
                                                                        <div class="item text-end">
                                                                            <label>&nbsp;</label>
                                                                            <button type="button"
                                                                                class="btn btn-danger btn-sm remove-postcode btn-block">Remove</button>
                                                                        </div>
                                                                    </div>
                                                @endforeach
                            @endif
