    ...
    <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body table-responsive">
            <table id="datable_1" class="table border table-hover ">
               <tr class="bg-light">
                ...
                <tr>
                  ...
                  <td align="center">
                   <!-- <a href="{{ url('/')}}/gst/manage-party/add/{{ $value['id'] }}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>  -->
                      <a href="{{ url('/')}}/AutoCare/supplier/delete/{{ $value['id']}} " class="text-danger" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>  
                @endforeach
              </tbody>
