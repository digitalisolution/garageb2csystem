                        ...
                        <div class="tab-pane active in" id="tab-csv">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div id="api_order_details"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-12 form-group">
                                                    <label for="bond_api_mode">Bond API Mode</label>
                                                ...
                                                <div class="col-lg-3 col-md-6 col-12 form-group">
                                                    <label for="bond_api_code">Bond API Code</label>
                                                    {{ Form::text('api_order_details[bond_api_code]', isset($api_order_details['bond_api_code']) ? $api_order_details['bond_api_code'] : '', ['class' => 'form-control', 'placeholder' => 'Bond API Code']) }}
                                                </div>

                                                <div class="col-lg-3 col-md-6 col-12 form-group">
                                                    <label for="trading_point">Bond Trading Point</label>
                                                    {{ Form::text('api_order_details[trading_point]', isset($api_order_details['trading_point']) ? $api_order_details['trading_point'] : '', ['class' => 'form-control', 'placeholder' => 'Bond Trading Point']) }}
                                                </div>

                                                <div class="col-lg-3 col-md-6 col-12 form-group">
                                                    <label for="bond_status_autoorder">Bond Auto Order Status</label>
                                                    {{ Form::select('api_order_details[bond_status_autoorder]', ['1' => 'Enabled', '0' => 'Disabled'], isset($api_order_details['bond_status_autoorder']) ? $api_order_details['bond_status_autoorder'] : '', ['class' => 'form-control', 'placeholder' => 'Select Bond Auto Order Status']) }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    @elseif(isset($supplier_name) && $supplier_name=='tyresoft')
                                    <div class="col-lg-12">
                                        <div id="api_order_details">
                                        <div class="form-group" id="emailtext" style="display: none;">
                                          <label class="col-sm-2 control-label" for="input-csv_location">Email</label>
                                        ...
                                        <div id="divcsv1" style="display: none;"></div>
                                        <div id="divftp1" style="display:none;">
                                            <legend>Tyresoft FTP Mode</legend>
                                          <fieldset>
                                            <div class="form-group required">
                                              <label class="col-sm-2 control-label" for="input-remote_file">Remote File</label>
                                              <div class="col-sm-10">
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label" for="input-import_condition">Upload Mode</label>
                                                <div class="col-sm-10">
                                                        <input type="radio" name="api_order_details[tyresoft_upload_mode]" value="directory" {{ old('api_order_details.tyresoft_upload_mode', $api_order_details['tyresoft_upload_mode'] ?? '') == 'directory' ? 'checked' : '' }}>
                                                        Directory &nbsp; <input type="radio" name="api_order_details[tyresoft_upload_mode]" value="ftp" {{ old('api_order_details.tyresoft_upload_mode', $api_order_details['tyresoft_upload_mode'] ?? '') == 'ftp' ? 'checked' : '' }}>
                                                        FTP
                                                </div>
                                            </div>
                                            <div class="form-group required">
                                                <label class="col-sm-2 control-label" for="input-tyresoft_api_code">External Reference </label>
                                                <div class="col-sm-10">
                                                  {{ Form::text('api_order_details[external_ref_append]', isset($api_order_details['external_ref_append']) ? $api_order_details['external_ref_append'] : '', ['class' => 'form-control','id'=>'input-external_ref_append', 'placeholder' => 'Enter extenal ref append sting']) }}
                                                  <span><small>(A string or number to append to jobid/orderid eg. Dils-001, Dils-002)</small></span>
                                                </div>
                                            ...
                                            <div class="form-group required">
                                                <label class="col-sm-2 control-label" for="input-tyresoft_api_code">Item Type </label>
                                                <div class="col-sm-10">
                                                {{ Form::select('api_order_details[item_type]', ['' => 'Select Type', 'tyres' => 'Tyres Only', 'all' => 'All'], old('api_order_details.item_type', $item_type ?? ''), ['class' => 'form-control', 'id' => 'input-item_type']) }}
                                                  <span><small>(Send tyres or services to Tyresoft)</small></span>
                                                </div>
                                            </div>
                                            <div id="div-directory" style="display: block;">
                                                <div class="form-group required">
                                                    <label class="col-sm-2 control-label" for="input-tyresoft_api_code">Directory Path</label>
                                                    <div class="col-sm-10">
                                                      {{ Form::text('api_order_details[tyresoft_dir_path]', isset($api_order_details['tyresoft_dir_path']) ? $api_order_details['tyresoft_dir_path'] : '', ['class' => 'form-control','id'=>'input-tyresoft_dir_path', 'placeholder' => 'Enter FTP Host']) }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="div-ftp" style="display: none;">
                                                <div class="form-group required">
                                                    <label class="col-sm-2 control-label" for="input-tyresoft_api_code">FTP Host</label>
                                                    <div class="col-sm-10">
                                                        {{ Form::text('api_order_details[tyresoft_ftp_host]', isset($api_order_details['tyresoft_ftp_host']) ? $api_order_details['tyresoft_ftp_host'] : '', ['class' => 'form-control','id'=>'input-tyresoft_ftp_host', 'placeholder' => 'Enter FTP Host']) }}
                                                    </div>
                                                </div>
                                                <div class="form-group required">
                                                    <label class="col-sm-2 control-label" for="input-tyresoft_api_code">FTP UserName</label>
                                                    <div class="col-sm-10">
                                                     
                                                      {{ Form::text('api_order_details[tyresoft_ftp_username]', isset($api_order_details['tyresoft_ftp_username']) ? $api_order_details['tyresoft_ftp_username'] : '', ['class' => 'form-control','id'=>'input-tyresoft_ftp_username', 'placeholder' => 'Enter FTP Username']) }}
                                                    </div>
                                                </div>
                                                <div class="form-group required">
                                                    <label class="col-sm-2 control-label" for="input-tyresoft_api_code">FTP Password</label>
                                                    <div class="col-sm-10">
                                                     
                                                      {{ Form::text('api_order_details[tyresoft_ftp_password]', isset($api_order_details['tyresoft_ftp_password']) ? $api_order_details['tyresoft_ftp_password'] : '', ['class' => 'form-control','id'=>'input-tyresoft_ftp_password', 'placeholder' => 'Enter FTP Password']) }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group required">
                                                <label class="col-sm-2 control-label" for="input-ftp_password">Enable Auto Orders</label>
                                                <div class="col-sm-10">
                                                   <select name="api_order_details[tyresoft_status_autoorder]" id="input-status_autoorder" class="form-control">
                                                       <option value="1">Enabled</option>
                                                        <option value="0">Disabled</option>
                                                    </select>
                                                </div>
                                        ...
                                        <script type="text/javascript">
                                            $(document).ready(function () {
                                            function toggleUploadMode() {
                                            var mode = $('input[name="api_order_details[tyresoft_upload_mode]"]:checked').val();
                                            if (mode === 'directory') {
                                            $('#div-directory').show();
                                            $('#div-ftp').hide();
                                            } else if (mode === 'ftp') {
                                            ...
                                            $('input[name="api_order_details[tyresoft_upload_mode]"]').on('click', toggleUploadMode);
                                            toggleUploadMode();
                                            });
                                        </script>
                                        </div>
