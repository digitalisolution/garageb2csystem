...
<div class="tab-pane fade" id="delivery_time">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" href="#fully_fitted" data-toggle="tab"><strong>{{ __('Fully Fitted') }}</strong></a>
        </li>
        <li class="nav-item">
  ...
  <div class="tab-content">
    ...
    <div class="tab-pane active in" id="fully_fitted">
        ...
        <div class="text-right mb-2">
            <a href="javascript:void(0)" class="btn btn-primary"  onclick="AddDeliveryRow('customFields', 'fully_fitted', 'fully_fitted_')">
        ...
        @foreach (['start_hours', 'start_minutes', 'end_hours', 'end_minutes'] as $field)
                <select class='form-control' name='fully_fitted_{{ $field }}[]'>
                    ...
                    @foreach ($range as $val)
                        ...
                        <option value="{{ $formatted }}" {{ $vals[$field] == $formatted ? 'selected' : '' }}>{{ $formatted }}</option>
                    @endforeach
                </select>
        @endforeach

            <input type="number" class='form-control' minlength="0" name='fully_fitted_delivery_time[]' value="{{ $vals['delivery_time'] }}">
    ...
    <div class="tab-pane fade" id="mobile_fitted">
        ...
        <div class="text-right mb-2">
            <a href="javascript:void(0)" class="btn btn-info" onclick="AddDeliveryRow('customFieldsmobile', 'mobile_fitted', 'mobile_fitted_')">
                <i class="fa fa-plus-circle"></i> Add Row
            </a>
        </div>
    ...
    <div class="block-item d-flex gap-2 bg-light p-2 border">
        ...
        @endforeach
            ...
            <input type="number" class='form-control' minlength="0" name='mobile_fitted_delivery_time[]' value="{{ $vals['delivery_time'] }}">
