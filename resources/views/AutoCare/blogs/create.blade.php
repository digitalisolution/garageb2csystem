...
@section('content')
    <div class="container-fluid">
        <div class="bg-white p-3">
            ...
            @endif
            <form action="{{ isset($blog) ? route('blog.update', $blog->blog_id) : route('blog.store') }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-12 form-group">
                        ...
                        <textarea name="description" id="description"
                            class="form-control">{{ $blog->description ?? old('description') }}</textarea>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 form-group">
                        ...
                        <select name="category_id[]" id="category_id" class="form-control" required>
                            @foreach ($categories as $category)
                                <option value="{{ $category->category_id }}" {{ in_array($category->category_id, $oldCategories) ? 'selected' : '' }}>
                                    {{ $category->title }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    @php
                        ...
                        $imageFile = $blog->image ?? 'blog-image.png';
                    ...
                    @endphp
                        ...
                        @if (isset($blog) && $blog->image)
                            <img src="{{ $domainImageUrl }}"onerror="this.onerror=null;this.src='{{ $fallbackImageUrl }}';" alt="{{ $blog->title }}" style="width:100px;height: auto;">
