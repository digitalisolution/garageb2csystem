...
@section('content')
    ...
    $fallbackBannerImageUrl = asset($fallbackbannerPath . $bannerImageFile);
                        ...
                        <div class="col-lg-3 col-md-6 col-12 form-group">
                            <label for="service_commission_price">Commission Price <span class="text-danger">*</span></label>
                            <input type="number" step="0.01" class="form-control" id="service_commission_price" name="service_commission_price"
                                value="{{ old('service_commission_price', $service->service_commission_price ?? '') }}" required>
                        </div>
