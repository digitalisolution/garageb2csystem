...
@section('content')
    <section class="container-fluid">
            ...
            <div class="card-body">
                <div class=" form-group row">
                    @if (!isset($id))
                        <div class="col-md-3">
                            ...
                            <div class="invalid-feedback">
                                {{ $errors->has('customer_id') ? $errors->first('customer_id', ':message') : '' }}</div>
                        </div>
                    @endif
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="invalid-feedback">
                            {{ $errors->has('mobile') ? $errors->first('mobile', ':message') : '' }}</div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-none">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                {{ $errors->has('company_name') ? $errors->first('company_name', ':message') : '' }}</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
        ...
        'placeholder' => 'Reference'
                            ...
                            <div class="invalid-feedback">
                                {{ $errors->has('reference') ? $errors->first('reference', ':message') : '' }}</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    @if (isset($id))
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback">
                                    {{ $errors->has('status') ? $errors->first('status', ':message') : '' }}</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback">
                                    {{ $errors->has('status') ? $errors->first('status', ':status') : '' }}</div>
                            </div>
                        </div>
                    @endif
                    @php
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="invalid-feedback">
                            {{ $errors->has('workshop_date') ? $errors->first('workshop_date', ':message') : '' }}</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                {{ $errors->has('vehicle_make') ? $errors->first('vehicle_make', ':message') : '' }}</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                {{ $errors->has('vehicle_model') ? $errors->first('vehicle_model', ':message') : '' }}</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                {{ $errors->has('vehicle_vin') ? $errors->first('vehicle_vin', ':message') : '' }}</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                {{ $errors->has('vehicle_cc') ? $errors->first('vehicle_cc', ':message') : '' }}</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                {{ $errors->has('vehicle_axle') ? $errors->first('vehicle_axle', ':message') : '' }}</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                {{ $errors->has('mileage') ? $errors->first('mileage', ':message') : '' }}</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                {{ $errors->has('fitting_type') ? $errors->first('fitting_type', ':message') : '' }}</div>
                        </div>
                    </div>
                    <!-- REPLACE THE EXISTING GARAGE DROPDOWN SECTION WITH THIS -->
                    <div class="col-md-3" id="garageSelectionSection" style="display: none;">
                        <div class="form-group">
                            <label class="control-label" for="garages_data_name">Garage Fitting Name:&emsp;<span
                                    class="text-red">*</span></label>
                            <select id="garages_data_name" name="garages_data_name" class="form-control" required>
                                <option value="">-- Select Garage --</option>
                                <!-- Options will be populated via AJAX -->
                            </select>
                            <div class="invalid-feedback">
                                {{ $errors->has('garages_data_name') ? $errors->first('garages_data_name', ':message') : '' }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                {{ $errors->has('notes') ? $errors->first('notes', ':message') : '' }}</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @php
        ...
        $fitting_type = $sourceData->fitting_type ?? 'fully_fitted';
        $shipping_postcode = $sourceData->shipping_postcode ?? '';
        $callout_charges = $sourceData->shipping_price ?? 0;
        $callout_vat = $sourceData->shipping_tax_id ?? 0;
        $total_callout = $sourceData->shipping_price * 1.2 ?? 0;

        $garage_fitting_charges = $sourceData->garage_fitting_charges ?? 0;
        $garage_fitting_vat = $sourceData->garage_vat_class ?? 0;
        $total_garage_fitting = $sourceData->garage_fitting_price * 1.2 ?? 0;
    @endphp
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fittingTypeDropdown.addEventListener('change', function () {
                if (['mobile_fitted', 'mailorder'].includes(this.value)) {
                    ...
                    garageSelectionSection.style.display = 'none';
                    postcodeModal.show();
                } else if (this.value === 'fully_fitted') {
                    $('#calloutChargesSection').hide();
                    $('#garageFittingChargesSection').show();
                    garageSelectionSection.style.display = 'block';

                    if (garageDropdown.options.length <= 1) {
                        fetchGaragesList();
                    }
    ...
    @if(in_array($fitting_type, ['mobile_fitted', 'mailorder']))
        <script>
            $(document).ready(function () {
                ...
                // ADD GARAGE FITTING CHARGES FOR FULLY_FITTED
                if ('{{ $fitting_type }}' === 'fully_fitted') {
                    $('#garageFittingChargesSection').show();
                    $('#garageFittingCharges').text('£{{ number_format($total_garage_fitting, 2) }}');
                    $('#garage_fitting_charges_input').val('{{ $garage_fitting_charges }}');
                    $('#garage_fitting_vat_input').val('{{ $garage_fitting_vat }}');
                    $('#total_garage_fitting_input').val('{{ $total_garage_fitting }}');
                    window.garageFittingResponseData = {
                        fitting_price: {{ $garage_fitting_charges }},
                        includes_vat: {{ $garage_fitting_vat }},
                        total_price: {{ $total_garage_fitting }}
                };
                }
                updateTotals();
            });
                    ...
                    .then(data => {
                        if (data.success && data.garages) {
                            ...
                            if (garageDropdown.value) {
                                ...
                                window.garageFittingResponseData = {
                                    fitting_price: {{ $garage_fitting_charges ?? 0 }},
                                    includes_vat: {{ $garage_fitting_vat ?? 0 }},
                                };
                                updateTotals();
                            }
                        }
    ...
    <script>
        ...
        function updateTotals() {
            ...
            $('#tBodyForProductTable tr').each(function () {
                ...
                totalTyreQuantity += quantity; // Sum up all tyres
            ...
            // 2. Calculate Other Totals (Services, Parts, etc.)
            ...
            // 4. Calculate Garage Fitting (Fully Fitted) - PER TYRE BASIS
            if ($('#fitting_type').val() === 'fully_fitted' && window.garageFittingResponseData) {
                ...
                // Calculate Total Garage Price = (Price Per Tyre * Total Tyres)
