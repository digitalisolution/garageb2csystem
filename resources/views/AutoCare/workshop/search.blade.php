                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive"
                        ...
                        <tr>
                            ...
                            <td><span class="{{ $value->workshop_origin }}">{{ $value->workshop_origin }}</span></td>
                            ...
                            <td style="white-space: nowrap;" align="right">
                                ...
                                @else
                                    <a href="{{ url('/') }}/AutoCare/workshop/addinvoice/{{ $value->id }}"
                                        class="btn btn-primary btn-sm">Convert to Invoice
                                    </a>
                                @endif

                                <a data-toggle="modal" id="{{ $value->id }}" data-target="#workshopDiscount"
                                    data-balance-total="{{ $value->balance_price }}"
                                    class="btn btn-success openDiscountModelForWorkshop btn-sm">Discount</i></a>

                                <a data-toggle="modal" id="{{ $value->id }}" data-target="#workshopPayment"
                                    class="btn btn-success openPayentModelForWorkshop btn-sm"
                                ...
                                <form action="{{ url('/AutoCare/workshop/trash/' . $value->id) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
        ...
        {{ Form::textarea('commentsForWorkshop', old('commentsForWorkshop', isset($log) ? $log->comments : null), ['class' => 'form-control', 'id' => 'comments', 'style' => 'height: 40px;']) }}
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><button type="reset" class="btn btn-sm btn-danger"><i class="fa fa-ban"></i> Reset</button></td>
                            </tr>
                        </tfoot>
                    </table>
                </form>
