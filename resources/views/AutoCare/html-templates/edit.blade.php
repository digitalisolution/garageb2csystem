    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('AutoCare.html-templates.update', $htmlTemplate->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" class="form-control" id="title" value="{{ $htmlTemplate->title }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <label>
                    <input type="radio" name="status" value="1" {{ $htmlTemplate->status == 1 ? 'checked' : '' }} required>
                    Active
                </label>
                <label>
                    <input type="radio" name="status" value="0" {{ $htmlTemplate->status == 0 ? 'checked' : '' }} required>
                    Inactive
                </label>
            </div>
