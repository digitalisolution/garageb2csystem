...
{{ Form::open([
    ...
    'autocomplete' => 'OFF'
        ...
        ['class' => 'form-control', 'id' => 'customer_id', 'placeholder' => 'Select Customer']
                    ...
                    <div class="col-md-3">
                        ...
                        <label class="control-label" for="name"> Name<span class="text-red">*</span>&emsp;</label>
    ...
    'id' => 'vehicle_reg_number'
                    ...
                    <!-- <div class="col-md-3">
                                                                <div class="form-group">
                                                                <label class="control-label" for="vehicle_reg_number">Vehicle Reg
                                                                Number<span class="text-red">*</span></label>
                                                                {{ Form::text(
                                                                'vehicle_reg_number',
                                                                isset($vehicle_reg_number) ? $vehicle_reg_number : '',
                                                                [
                                                                'class' => 'form-control ',
                                                                'placeholder' => 'Vehicle Reg Number',
                                                                'autocapitalize' => 'word',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" for="make">Make:&emsp;</label>
                            {{ Form::text('make', isset($workshopVehicleData) && $workshopVehicleData->isNotEmpty() ? $workshopVehicleData->first()->make : '', [
    'class' => 'form-control ',
    'id' => 'make',
    'placeholder' => 'make Reading'
]) }}
                            <div class="invalid-feedback">
                                {{ $errors->has('make') ? $errors->first('make', ':message') : '' }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" for="model">Model:&emsp;</label>
                            {{ Form::text('model', isset($workshopVehicleData) && $workshopVehicleData->isNotEmpty() ? $workshopVehicleData->first()->model : '', [
    'class' => 'form-control ',
    'id' => 'model',
    'placeholder' => 'model Reading'
]) }}
                            <div class="invalid-feedback">
                                {{ $errors->has('model') ? $errors->first('model', ':message') : '' }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" for="first_registered">Manufacture Year:&emsp;</label>
                            {{ Form::text('first_registered', isset($workshopVehicleData) && $workshopVehicleData->isNotEmpty() ? $workshopVehicleData->first()->first_registered : '', [
    'class' => 'form-control ',
    'id' => 'first_registered',
    'placeholder' => 'First Registered Reading'
]) }}
                            <div class="invalid-feedback">
                                {{ $errors->has('first_registered') ? $errors->first('first_registered', ':message') : '' }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" for="front_tyre_size">Front Tyre Size:&emsp;</label>
                            {{ Form::text('front_tyre_size', isset($workshopVehicleData) && $workshopVehicleData->isNotEmpty() ? $workshopVehicleData->first()->front_tyre_size : '', [
    'class' => 'form-control ',
    'id' => 'front_tyre_size',
    'placeholder' => 'Front Tyre Size Reading'
]) }}
                            <div class="invalid-feedback">
                                {{ $errors->has('front_tyre_size') ? $errors->first('front_tyre_size', ':message') : '' }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" for="rear_tyre_size">Rear Tyre Size:&emsp;</label>
                            {{ Form::text('rear_tyre_size', isset($workshopVehicleData) && $workshopVehicleData->isNotEmpty() ? $workshopVehicleData->first()->rear_tyre_size : '', [
    'class' => 'form-control ',
    'id' => 'rear_tyre_size',
    'placeholder' => 'Rear Tyre Size Reading'
]) }}
                            <div class="invalid-feedback">
                                {{ $errors->has('rear_tyre_size') ? $errors->first('rear_tyre_size', ':message') : '' }}
                            </div>
                        </div>
                    </div>
                   <div class="col-md-3">
<div class="form-group">
    <label class="control-label" for="vin">Vin:&emsp;</label>
    {{ Form::text('vin', isset($workshopVehicleData) && $workshopVehicleData->isNotEmpty() ? $workshopVehicleData->first()->vin : '', [
        'class' => 'form-control',
        'id' => 'vin',
        'placeholder' => 'VIN Reading'
    ]) }}
    <div class="invalid-feedback">
    ...
    'placeholder' => 'Vehicle CC Reading'
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {{ Form::text('engine_number', isset($workshopVehicleData) && $workshopVehicleData->isNotEmpty() ? $workshopVehicleData->first()->engine_number : '', [
    'class' => 'form-control ',
    'id' => 'engine_number',
    'placeholder' => 'Engine Number Reading'
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" for="engine_size">Engine Size:&emsp;</label>
                            {{ Form::text('engine_size', isset($workshopVehicleData) && $workshopVehicleData->isNotEmpty() ? $workshopVehicleData->first()->engine_size : '', [
    'class' => 'form-control ',
    'id' => 'engine_size',
    'placeholder' => 'Engine Size Reading'
]) }}
                            <div class="invalid-feedback">
                                {{ $errors->has('engine_size') ? $errors->first('engine_size', ':message') : '' }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" for="axle">Axle:&emsp;</label>
                            {{ Form::text('axle',isset($workshopVehicleData) && $workshopVehicleData->isNotEmpty() ? $workshopVehicleData->first()->axle : '', [
    'class' => 'form-control ',
    'id' => 'axle',
    'placeholder' => 'axle Reading'
]) }}
                            <div class="invalid-feedback">
                                {{ $errors->has('axle') ? $errors->first('axle', ':message') : '' }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {{ Form::text('fuel_type', isset($workshopVehicleData) && $workshopVehicleData->isNotEmpty() ? $workshopVehicleData->first()->fuel_type : '', [
    'class' => 'form-control ',
    'id' => 'fuel_type',
    'placeholder' => 'Fuel Type Reading'
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {{ Form::text('mileage',isset($workshopVehicleData) && $workshopVehicleData->isNotEmpty() ? $workshopVehicleData->first()->mileage : '', [
    'class' => 'form-control ',
    'id' => 'mileage',
    'placeholder' => 'Mileage Reading'
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" for="mot_expiry_date">Mot Expiry Date:&emsp;</label>
                            {{ Form::date('mot_expiry_date', isset($workshopVehicleData) && $workshopVehicleData->isNotEmpty() ? $workshopVehicleData->first()->mot_expiry_date : '', [
    'class' => 'form-control ',
    'id' => 'mot_expiry_date',
    'placeholder' => 'Mot Expiry Date Reading'
]) }}
                            <div class="invalid-feedback">
                                {{ $errors->has('mot_expiry_date') ? $errors->first('mot_expiry_date', ':message') : '' }}
                            </div>
                        </div>
                    </div>
                    @if (!isset($id))
    ...
    $incrementedId = 0;
        ...
        $totalAmount = $subtotal + $vatAmount; // Total with VAT
                        ...
                        <input type="hidden" name="ean[]" value="{{ $value->item_ean }}">
                        <input type="hidden" name="sku[]" value="{{ $value->item_sku }}">
                        <input type="hidden" name="supplier" value="{{ $value->supplier }}">
                        <input type="hidden" name="product_type" value="tyre">

                        <input type="hidden" name="description[]" value="{{ $value->description }}" required>
...
$incrimentedId_es = 0;
        ...
        <div class="col-md-12 text-center mt-3 mb-3">
            <button type="submit" class="btn btn-sm btn-primary" name=""> <i class="fa fa-dot-circle-o"></i>{{
    isset($id) ? 'Update' : 'Add' }}</button>
            ...
            $('[name=registered_vehicle]').on("change", function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('[name=year]').val(data[0].year);
                        $('[name=front_tyre_size]').val(data[0].front_tyre_size);
                        $('[name=rear_tyre_size]').val(data[0].rear_tyre_size);
                        $('[name=vin]').val(data[0].vin);
                        $('[name=first_registered]').val(data[0].first_registered);
                        $('[name=vehicle_cc]').val(data[0].vehicle_cc);
                        $('[name=engine_number]').val(data[0].engine_number);
                        $('[name=engine_size]').val(data[0].engine_size);
                        $('[name=axle]').val(data[0].axle);
                        $('[name=fuel_type]').val(data[0].fuel_type);
                        $('[name=mot_expiry_date]').val(data[0].mot_expiry_date);
                        ...
                        // $('[name=mileage]').val(data[0].mileage);
                        // $('[name=color]').val(data[0].color);
                        // $('[name=key_number]').val(data[0].key_number);

                        // $("[name=model_number]").select2("val", data[0].model_number
                        //     .toString());
                        // if (typeof (Storage) != "undefined") {
                        //     localStorage.setItem("model_number_localStorage", data[0]
                        //         .model_number.toString());
                        // }
                    ...
                    success: function (data) {
                        ...
                        for (index = 0; index < vehicalRegNum.length; ++index) {
                            $('#registered_vehicle').append(
                                '<option value="' + vehicalRegNum[index][
                                'vehicle_reg_number'
                                ] + '">' + vehicalRegNum[index]['vehicle_reg_number'] +
                                '</option>'
                            );
                        }
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('change', '.vat-rate, .quantity, .price', function () {
                ...
                updateServiceTotals();  // Ensure service total is updated
                updateTotals();         // Ensure grand total is updated
            });
        ...
        $(document).ready(function () {
                    ...
                    success: function (response) {
                        ...
                        if (Array.isArray(suppliers)) {
                            ...
                            suppliers.forEach((supplier) => {
                                supplierDropdown.append(`<option value="${supplier.supplier_name}">${supplier.supplier_name}</option>`);
                            });
                        } else {
            ...
            function populateTable(products) {
                ...
                products.forEach((product) => {
                    ...
                    <td>${product.ean} ${product.description || ''} ${product.tyre_width}/${product.tyre_profile}R${product.tyre_diameter}</td>
                    <td>${product.tyre_eco || ''}</td>
                    <td>${product.tyre_disfr || ''}</td>
                    <td>${product.tyre_db || ''}</td>
                    <td>${product.vehicle_type || ''}</td>
                    <td>${product.tyre_antiflat || ''}</td>
                    <td>${product.tyre_type || ''}</td>
                    <td>${product.quantity || ''}</td>
                    <td>${!isNaN(parseFloat(product.price)) ? parseFloat(product.price).toFixed(2) : ''}</td>
                    <td>${product.selected_price || ''}</td>
                    <td>${product.trade_costprice || ''}</td>
                    <td>${product.tyre_source || ''}</td>
            ...
            function applyFilters() {
                ...
                currentFilters = {
                    ...
                    brand_name: $('#brandFilter').val(),
                    tyre_source: $('#supplier').val(),
                    tyre_antiflat: rftFilterValue,
            ...
            function attachSelectEvent(products) {
                $(document).off('click', '.selectTyre').on('click', '.selectTyre', function (event) {
                    ...
                    if (selectedProduct) {
                        ...
                        const rate = (selectedPrice - price) + price;
                        const vatType = selectedProduct.tax_class_id === 9 ? 9 : 0;
                        const amount = rate * (1 + vatType / 100);
                        const itemValue = ` ${selectedProduct.description}`;
                        ...
                        <input type="hidden" name="ean[]" value="${selectedProduct.ean}">
                        <input type="hidden" name="sku[]" value="${selectedProduct.sku}">
                        <input type="hidden" name="supplier" value="${selectedProduct.tyre_source}">
                        <input type="hidden" name="product_type" value="tyre">
                        <input type="hidden" name="item[]" value="${itemValue}" class="form-control" required>
                        <input type="hidden" name="description[]" value="${selectedProduct.description}" class="form-control" required>
                        <td> ${itemValue}</td>
                        ...
                        <td>
                        <input type="number" step="0.01" name="cost_price[]"  value="${price.toFixed(2)}" class="form-control" required>
                        </td>
                        <td>
        ...
        document.getElementById('lookupButton').addEventListener('click', async function () {
            ...
            try {
                ...
                if (response.ok && result.success && result.data) {
                    ...
                    document.getElementById('first_registered').value = vehicleDetails.YearOfManufacture || '';

                    document.getElementById('engine_size').value = SmmtDetails.EngineCapacityCc || '';
                    document.getElementById('axle').value = SmmtDetails.DriveType || '';
                    ...
                    document.getElementById('mot_expiry_date').value = motHistory.split("T")[0] || '';
                } else {
