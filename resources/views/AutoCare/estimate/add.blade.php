...
@section('content')
        ...
        'autocomplete' => 'OFF'
            ...
            <div class="">
                <h5>Please Fill Up Estimate Details</h5>
                                    ...
                                    <div class="alert alert-{{ session('message.level') }} alert-dismissible"
                                        ...
                                        @if (isset($id))
                                            <div class="text-center text-primary"><a id="openWorkshopDetail"
                                                    href="{{ url('/') }}/AutoCare/estimate/view/{{ isset($id) ? $id : '' }}">Show
                                                    Detail</a></div>
                                        ...
                                        @else
                                            <div class="text-center text-primary"><a id="openWorkshopDetail"
                                                    href="{{ url('/') }}/AutoCare/estimate/view/{{ isset($workshopId) ? $workshopId : '' }}">Show
                                                    Detail</a></div>
                                            <script type="text/javascript">
                                                $(document).ready(function () {
                                                    setTimeout(function () {
    ...
    'placeholder' => 'Mot Expiry Date Reading'
        ...
        'style' => 'height:50px'
            ...
            <div class="card">
                ...
                @include('AutoCare/estimate/tyre-modal')
                @include('AutoCare/estimate/service-modal')
    ...
    <button type="reset" class="btn btn-sm btn-danger" name="reset"> 
        ...
        @if (!isset($id))
        @include('AutoCare/estimate/modal/add_customer')
        @include('AutoCare/estimate/modal/add_vehicle')
        @include('AutoCare/estimate/modal/vrm_customer')
        @include('AutoCare/estimate/modal/add_tyre')
        @endif
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
               ...
               $('[name=customer_id]').on("change", function () {
                ...
                if (workshopId != "") {
                    location.href = "{{ url('/') }}/AutoCare/estimate/view/" + workshopId;
                }
            });
        </script>
        <script>
