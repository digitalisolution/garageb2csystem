...
$defaultLogoPath = public_path("frontend/themes/theme/img/logo/logo.png");
                ...
                <div class="col-sm-4 text-sm-end text-center order-sm-1">
                    ...
                    <h5 class="mt-2 mb-0"><strong>INVOICE ID </strong>#{{ $invoice->workshop_id }}</h5>
        ...
        <main>
            <div class="ingray_strip">
                <div class="item"><strong>Invoice Date:</strong> {{ $invoice->created_at }}</div>
                <div class="item"><strong>Job Date:</strong> {{ $invoice->workshop_date }}</div>
                <div class="item"> <strong>Due Date:</strong> {{ $invoice->due_out }}</div>
                <div class="item"> <strong>Job ID #</strong>{{ $invoice->workshop_id }}</div>
            </div>
            <div class="row">
                <div class="col-sm-6 col-6"> <strong>Bill To</strong>
                    <address class="mt-2">
                        @if ($invoice->mobile || $invoice->email)
                            <strong>{{ $invoice->name }}</strong><br />
                            Telephone: {{ $invoice->mobile }}<br /> Email: {{ $invoice->email }}<br />
                        @endif
                        @if ($invoice->address)
            ...
            <div class="table-responsive mt-5 mb-5">
                <table class="table border mb-0">
                    ...
                    <tbody>
                        <tr class="bg-light">
                            <td class="text-uppercase">{{ $invoice->vehicle_reg_number }}</td>
                            <td>{{ $invoice->make }}</td>
                            <td>{{ $invoice->model }} / {{ $invoice->year }}</td>
                            <td> </td>
                            <td> </td>
                    ...
                    <table class="table border mb-0">
                        ...
                        <tbody>
                            ...
                            @foreach($WorkshopTyre as $tyre)
                                            ...
                                            <tr>
                                                <td>{{ $itemIndex++ }}</td>
                                                <td>{{ $tyre->description }} <br> ({{ $tyre->item_ean }})</td>
        ...
        <footer class="text-center mt-4">
            <p class="text-1"><strong>Descripition/Notes:</strong> {{ $invoice->notes }}</p>
