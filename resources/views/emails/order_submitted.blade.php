                        ...
                        <tr>
                          <td>
                            <div style="font-size:16px;text-align:left;">
                              Hello,<br>
                              Here is your <strong>one time Verification Code</strong> to share your garage service
                              center to verify your service will <strong>completed perfectly!</strong><br>
                              <span
                                style="display:inline-block; padding:15px 25px; font-size:22px; background-color:#f3f4f6; border:1px dashed #9ca3af; border-radius:4px; font-weight:bold;color:green;margin-top:15px;margin-bottom:50px;text-align:center;width:91%;">Verification
                                Code:- {{  $workshop->verification_code }}</span>
                            </div>
                          </td>
                        </tr>
                        <tr>
                                                            ...
                                                            @foreach ($workshopProducts as $product)
                                                              ...
                                                              <tr>
                                                                <td valign="middle" align="left"
                                                                  ...
                                                                  <small>
                                                                    @if($product->product_type === 'tyre')
                                                                      EAN: ({{ $product->product_ean ?? $product->product_sku }})
                                                    ...
                                                    <td align="left" valign="top" style="color:#212121;display:block">
                                                      <table width="100%" style="margin-bottom:0px;border-bottom:1px solid #f0f0f0">
                                                        <tbody>
                                                          ...
                                                          @endif
                                                          <!-- END NEW GARAGE FITTING CHARGES ROW -->
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                              <p
                                                                style="margin-top:14px;font-family:Arial;font-size:12px;text-align:right;color:#3f3f3f;padding-top:0px;margin-top:0;margin-bottom:3px">
                                                                <!-- Added $garageFittingVAT to total VAT calculation -->
                                                                <span
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                              <p
                                                                ...
                                                                <!-- Added $garageFittingCharges and $garageFittingVAT to Total calculation -->
                                                                <span
